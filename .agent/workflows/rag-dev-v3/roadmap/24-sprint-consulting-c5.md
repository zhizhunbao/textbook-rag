...
**验收标准**:
- [ ] Citation chip: 角色知识库 → 蓝色；个人文档 → 橙色
- [ ] Tooltip 显示来源类型 + 文件名
- [ ] 复用 EvalScoreCard 配色体系
...
**验收标准**:
- [ ] 新目录 `features/consulting/history/`
- [ ] ConsultingHistoryPanel 按角色分组显示历史会话
- [ ] 点击会话加载历史消息
- [ ] 支持删除会话
...
**验收标准**:
- [ ] 非 admin 不可访问 `/engine/*` 路由
- [ ] AppSidebar 对非 admin 隐藏 Engine 菜单组
