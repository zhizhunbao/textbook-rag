...
> 
> **总进度**: 56/158 stories 完成 (35%), ~426.5h 总工时 (含 Sprint Demo 14 stories)
...
| [12-sprint-demo.md](./roadmap/12-sprint-demo.md) | 🆕 **Demo Sprint** | **展示日冲刺** — 14 stories, 10.5h 🆕 全书搜索+暖色主题+建议问题+Citation Score+Report MVP+Admin分离 |
...
| [11-sprint-acquisition.md](./roadmap/11-sprint-acquisition.md) | **Sprint 执行计划** | 数据导入全流程一页化 — 13 stories, 34h 🚧 5/13 (AQ-08 Pipeline Tab 进行中) |
