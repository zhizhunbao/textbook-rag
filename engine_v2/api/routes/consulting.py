...
# ============================================================
# G4-03: Disclaimer constants + auto-append helper
# ============================================================
_DISCLAIMER_ZH = (
    "\n\n---\n"
...
# Keywords used to detect if a disclaimer is already present
_DISCLAIMER_MARKERS = ("免责声明", "Disclaimer", "disclaimer")
...
def _append_disclaimer(answer: str, question: str) -> str:
    """Append disclaimer if not already present. Language matches the question."""
    if any(marker in answer for marker in _DISCLAIMER_MARKERS):
        return answer  # already has disclaimer
    disclaimer = _DISCLAIMER_ZH if _is_chinese_question(question) else _DISCLAIMER_EN
