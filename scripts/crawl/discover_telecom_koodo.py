"""Discover Koodo plan URLs.

Category: telecom-koodo, Collection: ca_telecom_koodo.
Network: Telus (Flanker tier)

Usage:
    uv run python scripts/crawl/discover_koodo.py
    uv run python scripts/crawl/discover_koodo.py --supplemental-only
"""
...
SUPPLEMENTAL_URLS = [
    ...
    "https://www.koodomobile.com/en/phones",
    "https://www.koodomobile.com/en/services/pickyourperk",
    "https://www.koodomobile.com/en/services/add-a-line",
    "https://www.koodomobile.com/en/services/streaming",
...
async def run_bfs_discovery(headless=True):
    ...
    for i, url in enumerate(BFS_SEEDS):
        ...
        def url_filter(u):
            return urlparse(u).netloc in ("www.koodomobile.com", "koodomobile.com")
        try:
