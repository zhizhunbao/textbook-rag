"""Discover TekSavvy Internet plan URLs.
Category: internet-teksavvy, Collection: ca_internet_teksavvy.
Budget ISP — popular newcomer recommendation.
"""
...
BFS_SEEDS = ["https://www.teksavvy.com/internet"]
BFS_DEPTH = 2
BFS_MAX_PAGES = 200
SUPPLEMENTAL_URLS = [
    "https://www.teksavvy.com/internet",
    "https://www.teksavvy.com/internet/cable",
    "https://www.teksavvy.com/internet/dsl",
    "https://www.teksavvy.com/internet/fibre",
    "https://www.teksavvy.com/why-teksavvy",
]
...
async def run_bfs_discovery(headless=True):
    ...
    for i, url in enumerate(BFS_SEEDS):
        ...
        def url_filter(u):
            return urlparse(u).netloc in ("www.teksavvy.com", "teksavvy.com")
        try:
