"""Discover Rogers Internet plan URLs.
Category: internet-rogers, Collection: ca_internet_rogers.
"""
...
BFS_SEEDS = ["https://www.rogers.com/internet"]
BFS_DEPTH = 2
BFS_MAX_PAGES = 200
SUPPLEMENTAL_URLS = [
    "https://www.rogers.com/internet",
    "https://www.rogers.com/internet/fibre",
    "https://www.rogers.com/internet/deals",
]
...
async def run_bfs_discovery(headless=True):
    ...
    for i, url in enumerate(BFS_SEEDS):
        ...
        def url_filter(u):
            return urlparse(u).netloc in ("www.rogers.com", "rogers.com")
        try:
