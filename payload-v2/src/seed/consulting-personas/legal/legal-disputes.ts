...
export const legalDisputes: PersonaSeed = {
  name: 'Rental & Workplace Disputes Advisor',
  slug: 'legal-disputes',
  country: 'ca',
  category: 'legal',
  icon: 'gavel',
  description: 'LTB complaints, labor arbitration, small claims court, and dispute resolution procedures.',
...
{query_str}`,
  ...
  suggestedQuestions: [
    { id: 'rental_disputes', label: 'Rental Disputes', icon: '🏠', questions: [
    ...
    { id: 'workplace', label: 'Workplace Disputes', icon: '💼', questions: [
