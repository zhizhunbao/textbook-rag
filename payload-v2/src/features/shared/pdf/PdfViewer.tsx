...
export default function PdfViewer() {
  ...
  // Text-layer snippet matching removed — MinerU bbox overlays (BboxOverlay)
  // provide pixel-accurate highlighting. Text-layer matching was unreliable
  // for multi-column PDFs and caused incorrect highlight positioning.
